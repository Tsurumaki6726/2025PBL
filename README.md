...
2. [Node.js 公式サイト](https://nodejs.org/) から **LTS版（推奨版）** をダウンロードしてインストールしてください
3. インストール完了後、ターミナルを再起動してください
...
プロジェクトに必要なすべてのライブラリ（`package.json`に定義済み）を一括でインストールします。
